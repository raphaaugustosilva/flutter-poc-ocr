...
class OCRHelper {
  static Future<Map<String, dynamic>> ocrFoto(
      File arquivoImagem, OrdemLeituraDadosEnum ordemLeituraDados) async {
    Map<String, dynamic> _textosEncontrados = Map<String, dynamic>();
    final FirebaseVisionImage visionImage =
        FirebaseVisionImage.fromFile(arquivoImagem);
